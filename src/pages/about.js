          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                ...
                relationships. SocialLens is more than just a social media
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <p className="text-lg text-gray-700 mb-4">
                    At SocialLens, we believe in the power of authentic
                    connections. Our mission is to create a platform where
                    people can share their stories, connect with others, and
                    build meaningful relationships in a safe and supportive
                    environment.
                  </p>
                  <p className="text-lg text-gray-700">
                    We're committed to fostering a community that values
                    creativity, empathy, and genuine human connection over
                    superficial metrics and engagement.
                  </p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8 mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    We encourage real, genuine content that reflects who you
                    truly are.
                  </p>
                </div>
                <div className="text-center">
