...
import UploadStory from "@/components/upload-story/UploadStory"
...
const Story = () => {
  ...
  return (
    <>
      <div className="h-[120px] flex flex-col flex-wrap overflow-x-auto hide-scrollbar mt-[0px] xl:ml-[15px] xl:mr-[50px]">
        <ul className="flex mx-3">
          {currentUser && (
            <li className="relative text-center ml-4 mr-2 flex-shrink-0">
              <div
